...
import {
  ...
  getSubtotal,
  removeFromCart,
} from "../feature/products/cartSlice";
    ...
    <div className="cart-section container mx-auto py-10">
      ...
      <div className="text-center">
        {data.length === 0 && (
          <Link
            to="/products"
            className="text-center text-sky-500 inline-block"
          >
            Start shopping now
          </Link>
        )}
              ...
              {data?.map((product) => (
                ...
                >
                  ...
                  <div className="total-price ml-auto">
                    {currencyFormator(product.price * product.cartQuantity)}
                  </div>
                </div>
              ))}
            </div>
